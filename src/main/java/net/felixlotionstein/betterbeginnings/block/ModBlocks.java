...
public class ModBlocks {
    public static final Block ROCK_BLOCK = new RockBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAVEL)
    ...
    private static void registerBlockWithItem(String name, Block block) {
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(BetterBeginnings.MODID, name);
